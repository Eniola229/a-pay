...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero::after { content: ''; position: absolute; bottom: -40px; left: -40px; width: 180px; height: 180px; background: radial-gradient(circle, rgba(0,191,165,0.1) 0%, transparent 70%); border-radius: 50%; }
        ...
        .shield-badge { position: absolute; top: 40px; right: 40px; width: 56px; height: 56px; background: linear-gradient(135deg, #00e676, #00bfa5); border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 8px 24px rgba(0,230,118,0.4); z-index: 1; }
        ...
        .code-label { font-size: 11px; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; color: #00a152; margin-bottom: 16px; }
        .code-box { display: inline-block; background: linear-gradient(135deg, #00251a, #003d2a); border-radius: 16px; padding: 24px 40px; margin-bottom: 16px; box-shadow: 0 16px 40px rgba(0,230,118,0.25); }
        .code-value { font-family: 'JetBrains Mono', monospace; font-size: 48px; font-weight: 600; color: #00e676; letter-spacing: 12px; line-height: 1; }
        ...
        .info-card { background: #f7fdf8; border: 1px solid #e0f0e3; border-radius: 16px; padding: 20px; margin-bottom: 28px; }
        .info-row { display: flex; align-items: flex-start; gap: 12px; padding: 8px 0; border-bottom: 1px solid #e8f5e9; }
        .info-row:last-child { border-bottom: none; padding-bottom: 0; }
        .info-icon { font-size: 16px; flex-shrink: 0; margin-top: 1px; }
        .info-text { font-size: 13px; color: #1a2e1a; line-height: 1.5; }
        .info-text strong { color: #00a152; }
        .warning-note { background: #fffbf0; border: 1px solid #ffd54f; border-radius: 12px; padding: 14px 18px; display: flex; gap: 12px; align-items: flex-start; margin-bottom: 28px; }
        .warning-icon { font-size: 18px; flex-shrink: 0; }
        .warning-text { font-size: 12px; color: #795548; line-height: 1.6; }
        .warning-text strong { color: #5d4037; }
